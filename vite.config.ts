  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'RouteRun',
        description: 'Optimize and work your delivery route, stop by stop.',
        theme_color: '#FBFBFA',
      ...
      workbox: {
        // Precache the app shell so it opens offline (cold start).
        globPatterns: ['**/*.{js,css,html,svg,png,woff2}'],
        runtimeCaching: [
          {
            // Cache map tiles the driver has already viewed, for offline.
